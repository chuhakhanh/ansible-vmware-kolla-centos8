...
openstack network create --share --external --provider-physical-network physnet1 --provider-network-type vlan --provider-segment=111 pro-vlan111
...
openstack network create --share --external --provider-physical-network physnet1 --provider-network-type flat provider-flat
openstack subnet create --subnet-range 10.1.0.0/16 --gateway 10.1.0.1 --network provider-flat --allocation-pool start=10.1.17.130,end=10.1.17.150 provider-flat-subnet
